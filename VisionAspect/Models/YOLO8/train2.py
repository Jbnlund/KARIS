...
BATCH_SIZE = 4 # if you run out of GPU memory, lower this
...
# flipping
FLIPLR = 0.2 # chance to flip object horizontally
FLIPUD = 0.2 # chance to flip object vertically

# YOLO-specific, these augmentations can be heavy (hardware-wise)
MOSAIC = 0.2 # chance to combine many images into one
